...
public class MenuManagement extends JFrame {
	...
	private JPanel createSidebar() {
		...
		String[][] menuData = { { "Menu", "img/menu.png" }, { "Menu Management", "img/menumanagement.png" },
		...
		table.getColumnModel().getColumn(6).setCellRenderer(new DefaultTableCellRenderer() {
			...
			public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
				...
				if (status.equals("Còn hàng")) {
					...
					label.setText(
							"<html><div style='background: #e6f4ea; padding: 2px 8px; border-radius: 10px;'>Còn hàng</div></html>");
				} else {
					label.setForeground(new Color(200, 50, 50));
					label.setText(
							"<html><div style='background: #fdeaea; padding: 2px 8px; border-radius: 10px;'>Hết hàng</div></html>");
				}
				return label;
			}
		});
